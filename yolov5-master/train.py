...
def train(hyp, opt, device, tb_writer=None):
    ...
    #freeze = ['models.common', ]  # parameter names to freeze (full or partial)
    if any(freeze):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='boat.yaml', help='data.yaml path')
    ...
    parser.add_argument('--name', default='boat', help='renames experiment folder exp{N} to exp{N}_{name} if supplied')
    parser.add_argument('--device', default='', help='cuda device, i.e. 0 or 0,1,2,3,4,5,6 or cpu')
